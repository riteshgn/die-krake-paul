...
y = match_data.result.apply(_convert_to_home_win_or_not)
predict_y = predict_data.result.apply(_convert_to_home_win_or_not)
...
plt.figure()
plot_confusion_matrix(confusion_matrix(predict_y, actual_predictions), classes=['H', 'N'],
...
# Specify Model
gb_match_model = GradientBoostingClassifier(n_estimators=500, random_state=1)
