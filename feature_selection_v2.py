...
class KaggleExtractor(object):
    ...
    def prepare_dataset(self, season, league_id):
        ...
        # print(df_home_player_stats.head(n=10))
        # print(df_home_player_stats.columns)
        ...
        # print(df_home_player_stats[['hp_age_median', 'hp_age_mean', 'hp_age_min', 'hp_age_max', 'hp_age_std', 'hp_age_25', 'hp_age_50', 'hp_age_75']].head())
        # print('\n')
        ...
        # features_to_select = ['hp_age_min', 'hp_age_max', 'hp_age_mean', 'hp_age_median', 'hp_age_std', 'hp_age_25',
        #                       'hp_age_50', 'hp_age_75', 'hp_height_min', 'hp_height_max', 'hp_height_mean',
        #                       'hp_height_median', 'hp_height_std', 'hp_height_25', 'hp_height_50', 'hp_height_75',
        #                       'hp_weight_min', 'hp_weight_max', 'hp_weight_mean', 'hp_weight_median', 'hp_weight_std',
        #                       'hp_weight_25', 'hp_weight_50', 'hp_weight_75', 'hp_avg_overall_rating_min',
        #                       'hp_avg_overall_rating_max', 'hp_avg_overall_rating_mean', 'hp_avg_overall_rating_median',
        #                       'hp_avg_overall_rating_std', 'hp_avg_overall_rating_25', 'hp_avg_overall_rating_50',
        #                       'hp_avg_overall_rating_75', 'ap_age_min', 'ap_age_max', 'ap_age_mean', 'ap_age_median',
        #                       'ap_age_std', 'ap_age_25', 'ap_age_50', 'ap_age_75', 'ap_height_min', 'ap_height_max',
        #                       'ap_height_mean', 'ap_height_median', 'ap_height_std', 'ap_height_25', 'ap_height_50',
        #                       'ap_height_75', 'ap_weight_min', 'ap_weight_max', 'ap_weight_mean', 'ap_weight_median',
        #                       'ap_weight_std', 'ap_weight_25', 'ap_weight_50', 'ap_weight_75',
        #                       'ap_avg_overall_rating_min', 'ap_avg_overall_rating_max', 'ap_avg_overall_rating_mean',
        #                       'ap_avg_overall_rating_median', 'ap_avg_overall_rating_std', 'ap_avg_overall_rating_25',
        #                       'ap_avg_overall_rating_50', 'ap_avg_overall_rating_75', 'result']
        # final_data_set = df_matchday_player_stats[features_to_select]
        ...
        columns_to_drop = columns_to_drop + ['id', 'date_x', 'date_y']
        final_data_set = df_matchday_player_stats.drop(columns=columns_to_drop)
        # print(list(final_data_set.columns))
        # print('\n')

        filename = 'kaggle_db/features_{}_{}_v2.csv'.format(season.replace('/', '_'), league_id)
...
def _append_player_stats(player, player_type, df_player_avg_overall_ratings):
    this_player = _append_player_ages(player, player_type, df_player_avg_overall_ratings)
    for stat in ['age', 'height', 'weight', 'avg_overall_rating']:
        key_extract = '{prefix}{index}_{property}'
        df_property = pd.Series([this_player[key_extract.format(prefix=player_type, index=plyr_indx, property=stat)]
                                 for plyr_indx in range(1, 12)])

        key_insert_prefix = '{prefix}_{property}_'.format(prefix=player_type, property=stat)
        this_player[key_insert_prefix + 'min'] = df_property.min()
        this_player[key_insert_prefix + 'max'] = df_property.max()
        this_player[key_insert_prefix + 'mean'] = df_property.mean()
        this_player[key_insert_prefix + 'median'] = df_property.median()
        this_player[key_insert_prefix + 'std'] = df_property.std()
        this_player[key_insert_prefix + '25'] = df_property.quantile(.25)
        this_player[key_insert_prefix + '50'] = df_property.quantile(.5)
        this_player[key_insert_prefix + '75'] = df_property.quantile(.75)
...
def _enhance_player_stats(df, player_type, df_player_avg_overall_ratings):
    ...
    return df.apply(lambda x: _append_player_stats(x, player_type, df_player_avg_overall_ratings), axis=1)
